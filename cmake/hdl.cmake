function(add_simulation_target target)
    ...
    add_custom_target(${target}_simulation
            COMMAND vvp ${CMAKE_CURRENT_BINARY_DIR}/${target}.sim -fst
            OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${target}.fst
            DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${target}.sim)
    add_custom_target(${target}_wave
            COMMAND open -a gtkwave ${CMAKE_CURRENT_BINARY_DIR}/${target}.fst
            DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${target}.fst)
